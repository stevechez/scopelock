...
export default function DashboardLayout({ children }: { children: ReactNode }) {
	return (
		<div className="min-h-screen bg-slate-950 selection:bg-amber-500/30 flex">
			...
			<div className="fixed inset-0 overflow-hidden ml-12 pointer-events-none">
    ...
    */}
				...
				<footer className="relative z-20 w-full px-10 pb-12 pt-8 pointer-events-none lg:pl-32">
					{' '}
					<div className="max-w-7xl flex justify-between items-center opacity-40 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500">
