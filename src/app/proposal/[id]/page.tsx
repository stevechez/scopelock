		...
		<div className="min-h-screen bg-slate-50 dark:bg-[#0B101E] py-12 md:py-24 px-6">
			<div className="max-w-4xl mx-auto">
				...
				<div className="flex items-center gap-3 mb-12 justify-center opacity-50">
					<HardHat size={24} className="text-foreground text-foreground" />
					<span className="font-black text-foreground text-foreground tracking-widest uppercase text-sm">
				...
				{isWon ? (
					...
					<div className="space-y-8">
						<div className="bg-background text-foreground border border-emerald-500/20 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
							<div className="text-center mb-10">
								...
								<h1 className="text-4xl font-black text-foreground text-foreground uppercase italic mb-2">
									Project Portal
								</h1>
									...
									{files.length === 0 ? (
										...
										files.map(file => (
											<a
												...
												href={file.file_url}
												target="_blank"
												className="p-5 bg-slate-50 dark:bg-white/[0.02] border border-border dark:border-white/5 rounded-2xl flex justify-between items-center transition-all hover:border-emerald-500/30 group"
											>
												<div className="flex items-center gap-3">
													<FileText className="text-emerald-500" size={18} />
													<span className="font-bold text-sm text-foreground text-foreground truncate max-w-[180px]">
														{file.file_name}
													</span>
												</div>
												<Download
													className="text-muted group-hover:text-emerald-500 transition-colors"
													size={18}
												/>
											</a>
										))
							...
							<section>
								...
								<div className="space-y-10 border-l-2 border-border dark:border-white/5 ml-4 pl-8">
									{updates.length === 0 ? (
										...
										updates.map(upd => (
											<div key={upd.id} className="relative">
												...
												<div className="bg-slate-50 dark:bg-white/[0.02] p-6 rounded-2xl border border-border dark:border-white/5">
													<div className="flex justify-between items-start mb-2">
														<h4 className="font-black uppercase text-foreground text-foreground italic">
															{upd.title}
														</h4>
					...
					<div className="bg-background text-foreground border border-border dark:border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
						<div className="border-b border-border dark:border-white/5 pb-8 mb-8 text-center">
							<h1 className="text-sm font-black text-amber-500 uppercase tracking-widest mb-4">
								Official Project Proposal
							</h1>
							<h2 className="text-4xl md:text-5xl font-black text-foreground text-foreground uppercase italic leading-none mb-4">
								{companyName}
							</h2>
							<p className="text-muted font-medium">
						...
						<div className="space-y-8 mb-12">
							<div>
								<h3 className="text-xs font-black text-muted uppercase tracking-widest mb-2 flex items-center gap-2">
									<FileText size={14} /> Project Scope
								</h3>
								<p className="text-xl font-medium text-foreground text-foreground">
							...
							<div className="bg-slate-50 dark:bg-[#0B101E] rounded-2xl p-6 border border-border dark:border-white/5">
								<h3 className="text-xs font-black text-muted uppercase tracking-widest mb-2">
