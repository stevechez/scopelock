		...
		<div className="min-h-screen bg-slate-50 selection:bg-slate-900 selection:text-white pb-32">
			...
			<main className="max-w-4xl mx-auto px-6 pt-32">
				...
				<div className="grid md:grid-cols-3 gap-6">
					{/* Direct Contact Card */}
					<div className="bg-white p-8 rounded-[2rem] shadow-xl border border-slate-100 md:col-span-2">
					...
					<div className="space-y-6">
						<div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col justify-center h-full">
