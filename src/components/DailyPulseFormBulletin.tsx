...
export function DailyPulseForm({ jobId }: { jobId: string }) {
	...
	return (
		<div className="flex flex-col gap-6">
			...
			<div className="relative w-full aspect-square bg-white border-2 border-dashed border-slate-200 rounded-3xl overflow-hidden flex items-center justify-center">
				{preview ? (
					<>
						<img
							src={preview}
					...
					<button
						...
						className="flex flex-col items-center gap-2 text-slate-400 active:scale-95 transition-transform"
					>
			...
			<div className="space-y-2">
				...
				<textarea
					...
					className="w-full bg-white border border-slate-200 rounded-2xl p-4 text-lg focus:outline-none focus:ring-2 focus:ring-slate-900 min-h-[100px]"
				/>
			</div>
