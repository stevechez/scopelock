	...
	return (
		<section className="py-28 bg-slate-50 dark:bg-slate-950 px-6">
			<div className="max-w-3xl mx-auto">
				<div className="bg-white dark:bg-slate-900 p-10 md:p-12 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-xl text-slate-700 dark:text-slate-300 leading-relaxed text-lg">
					{/* HEADER */}
					<div className="flex items-center gap-4 mb-8">
						<div className="w-16 h-16 rounded-full bg-slate-200 dark:bg-slate-800 border-2 border-amber-500 flex items-center justify-center text-2xl font-black text-slate-900 dark:text-white">
							SD
						</div>
					...
					{/* SIGNATURE */}
					<p className="mb-10 font-black text-slate-900 dark:text-white text-xl">
						— Steve Dunn
					</p>
