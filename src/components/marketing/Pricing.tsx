...
interface PricingProps {
  onCheckout?: (variantId: number) => Promise<void>;
  isLoading?: boolean;
}
...
export function Pricing({ onCheckout, isLoading }: PricingProps) {
  ...
  const tiers = [
    ...
    },
    {
      ...
      variantIds: { monthly: null, yearly: null },
      featured: false,
      comingSoon: true,
    },
  ];
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <button
                ...
                className={`w-full mt-auto py-4 px-6 rounded-2xl font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                  tier.featured
        ...
        <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 border-t border-border dark:border-white/5 pt-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-medium text-muted">
                Your system is live in minutes
              </span>
            </div>
          </div>
          <div className="flex items-center gap-3">
