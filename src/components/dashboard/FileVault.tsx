...
export default function FileVault({
	...
	return (
		<div className="bg-white dark:bg-[#0B101E] border border-slate-100 dark:border-white/5 rounded-[2.5rem] p-8">
			<div className="flex justify-between items-center mb-8">
				<h3 className="text-xl font-black text-slate-900 dark:text-white italic uppercase flex items-center gap-3">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				{files.length === 0 ? (
					<p className="col-span-2 text-center py-10 text-slate-400 font-bold uppercase text-[10px] tracking-widest">
					...
					files.map(file => (
						<div
							key={file.id}
							className="group flex items-center justify-between p-4 bg-slate-50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/5 rounded-2xl hover:border-blue-500/30 transition-all"
						>
							<div className="flex items-center gap-4">
								...
								<div className="truncate max-w-[150px] md:max-w-[200px]">
									<p className="font-black text-slate-900 dark:text-white uppercase text-xs truncate italic">
										{file.file_name}
									</p>
